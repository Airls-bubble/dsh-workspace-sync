...
/** 6-digit pairing short code — a LAN pointer, not the payload itself.
 *  The real identity+token travels over the local network (pair-claim route);
 *  the code only says "the machine showing this number is offering a pair". */
export function makeShortCode() {
  return String(randomInt(100000, 1000000));
}

/** Strict check: exactly six digits. */
