...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = `
.wss-wrap{display:flex;flex-direction:column;min-height:0;height:100%;color:#e8eaf0;font-size:13px}
.wss-backdrop{pointer-events:auto;position:fixed;inset:0;display:flex;justify-content:center;align-items:center;background:rgba(0,0,0,.55);z-index:100}
...
.wss-modal{pointer-events:auto;width:600px;max-width:94vw;height:min(760px,92vh);display:flex;flex-direction:column;position:relative;overflow:hidden;border-radius:14px;border:1px solid #303040;background:#16161c;color:#e8eaf0;box-shadow:0 8px 40px rgba(0,0,0,.5)}
.wss-head{display:flex;align-items:center;gap:10px;padding:14px 16px 12px;border-bottom:1px solid #303040;flex:none}
.wss-head svg{width:22px;height:22px;color:#7c93ff}
.wss-title{font-size:15px;font-weight:600}
.wss-sub{margin-left:auto;font-size:11px;color:#9aa3b2}
.wss-close{all:unset;cursor:pointer;color:#9aa3b2;font-size:12px;padding:4px 10px;border-radius:7px;border:1px solid #303040}
.wss-close:hover{color:#e8eaf0;border-color:#4a4a5a}
.wss-body{flex:1;min-height:0;overflow-y:auto;padding:14px 16px 20px;display:flex;flex-direction:column;gap:12px}
.wss-card{border:1px solid #2a2a35;border-radius:11px;padding:13px 14px;background:#1e1e27}
.wss-card h3{margin:0 0 8px;font-size:13px;font-weight:600;color:#c9cfda;display:flex;align-items:center;gap:6px}
.wss-kv{display:flex;gap:8px;margin:3px 0;font-size:12.5px;line-height:1.5}
.wss-k{color:#9aa3b2;flex:none;width:88px}
.wss-v{word-break:break-all;color:#e8eaf0}
.wss-row{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:6px}
.wss-input{flex:1;min-width:180px;background:#121218;color:#e8eaf0;border:1px solid #3a3a48;border-radius:6px;padding:5px 9px;font:inherit}
.wss-input::placeholder{color:#6b7280}
.wss-check{display:flex;align-items:center;gap:5px;margin-left:auto;font-size:12px;color:#c9cfda;cursor:pointer}
.wss-browser{margin-top:8px;border:1px solid #2a2a35;border-radius:8px;padding:8px;max-height:240px;overflow:auto;background:#14141a}
...
.wss-btn{cursor:pointer;border:1px solid #3a3a48;background:#26262f;color:#e8eaf0;border-radius:8px;padding:5px 12px;font-size:12.5px;font-weight:500;font-family:inherit}
.wss-btn:hover{background:#30303c}
.wss-btn:disabled{opacity:.45;cursor:not-allowed}
.wss-btn.primary{background:#4d6bfe;border-color:#4d6bfe;color:#fff}
.wss-btn.primary:hover{background:#3b55d9}
.wss-btn.danger{color:#f87171;border-color:#5b2530}
.wss-btn.danger:hover{background:rgba(248,113,113,.12)}
.wss-code{width:100%;box-sizing:border-box;border:1px solid #3a3a48;border-radius:8px;padding:8px 10px;font:12px ui-monospace,Menlo,monospace;background:#121218;color:#cdd3de;resize:vertical}
.wss-pre{margin:8px 0 0;padding:9px 11px;background:#121218;border:1px solid #2a2a35;border-radius:8px;font:11.5px ui-monospace,Menlo,monospace;white-space:pre-wrap;word-break:break-all;max-height:260px;overflow-y:auto;color:#cdd3de}
.wss-msg{font-size:12px;color:#4ade80;min-height:16px}
.wss-msg.err{color:#f87171}
.wss-peer{display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px dashed #2a2a35;font-size:12.5px}
.wss-peer:last-child{border-bottom:none}
.wss-peer .name{font-weight:600}
.wss-peer .id{color:#9aa3b2;font-family:ui-monospace,Menlo,monospace;font-size:11px}
.wss-badge{font-size:11px;padding:1px 8px;border-radius:9px;background:rgba(74,222,128,.14);color:#4ade80}
.wss-badge.off{background:rgba(148,163,184,.14);color:#9aa3b2}
.wss-note{font-size:11.5px;color:#9aa3b2;line-height:1.6;margin:6px 0 0}
`;
