    ...
    if (webServer && typeof webServer.register === "function") {
      const dispatch = async (method, args) => {
        ...
        switch (method) {
          ...
          case "pairImport": return svc.importPairCode(String(a.code || ""));
          case "pairOfferStart": return svc.startPairOffer();
          case "pairOfferCancel": return svc.cancelPairOffer();
          ...
          case "getScope": return svc.getScope();
          case "setScope": return svc.setScope(Array.isArray(a.excludes) ? a.excludes : String(a.excludes || "").split("\n"));
